...
#imprime error porque la función cantidad_de_dias_o_meses_o_semanas_en_anio no está definida

#3
def anio_independencia_chile():
    return 1810
    return 1851
print(anio_independencia_chile()) #imprime 1810
...
print(x) #imprime 2438 y None

#6
def suma(a, b):
    print(a+b)
print(suma(10, 5) + suma(4, 3)) #imprime 15, 7 y None
...
print(a)
funcion()
print(a) #imprime 150, 150, 350 y 150
...
print(a)
a = funcion()
print(a) #imprime 150, 150, 350 y 350
